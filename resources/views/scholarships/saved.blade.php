<x-master.layout
    title="Beasiswa Tersimpan Anda"
    label="Kumpulan beasiswa favorit yang telah Anda simpan untuk referensi nanti"
    >
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-1">
                <form method="GET" action="{{ route('scholarships.saved') }}" class="space-y-6">
            ...
            <div class="lg:col-span-3">
                            ...
                            <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow overflow-hidden border border-gray-200 flex flex-col h-full">
                                ...
                                <div class="px-4 py-4 bg-gray-50 border-t flex gap-2">
                                    ...
                                    <form action="{{ route('scholarships.toggleSave', $scholarship) }}" method="POST" class="flex-1">
                                        ...
                                        >
                                            <i class="fas fa-heart mr-2"></i> Hapus
                                        </button>
                                    </form>
                                </div>
                            </div>
                ...
                @else
                    ...
                    <div class="text-center py-16">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 mb-2">Belum ada beasiswa yang disimpan</h3>
                        <p class="text-gray-600 mb-6">Mulai cari beasiswa dan simpan beasiswa favorit Anda untuk referensi nanti</p>
                        <a href="{{ route('scholarships.index') }}" class="inline-block bg-blue-600 text-white font-semibold py-2 px-6 rounded-lg hover:bg-blue-700 transition">
                            <i class="fas fa-search mr-2"></i> Cari Beasiswa
                        </a>
                    </div>
                @endif
            </div>
